...
$(document).ready(function() {
    ...
    "/frontend" == window.location.pathname && $.ajax({
        ...
        for (var n in e) {
            ...
            1 == e[n].Datatype) var i = e[n].Distance, s = new Date(e[n].CurrentDateTime);
            if (2 == e[n].Datatype) {
                var a = new Date(e[n].CurrentDateTime).getHours() - s.getHours(), d = new Date(e[n].CurrentDateTime).getMinutes() - s.getMinutes();
